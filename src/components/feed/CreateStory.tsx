...
const CreateStory: FC<Props> = ({ src }) => {
  return (
    <div className="lg:relative h-16 w-16 md:h-20 md:w-20 lg:h-56 lg:w-32 p-3 cursor-pointer rounded-3xl transition duration-200 transform ease-in hover:scale-105 hover:animate-pulse bg-white">
      ...
      <div className="absolute hidden lg:flex justify-center bottom-0 left-0 bg-white dark:bg-gray-700 w-full h-1/4 rounded-b-3xl z-10">
        <p className="text-center text-sm font-semibold mt-7 dark:text-white">
          Create Story
        </p>
      </div>
    </div>
