...
const DropdownDisplay: React.FC<DropdownDisplayProps> = props => {
  ...
  return (
    <div
      className={`absolute flex flex-col items-center w-full h-full p-4 bg-white rounded-lg top-0 left-0 dark:bg-gray-700 dark:text-gray-200 transition-all duration-200 ease-in transform translate-x-96 ${
        displayOptionsOpen && "translate-x-0"
      }`}>
